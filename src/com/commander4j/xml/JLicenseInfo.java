...
public class JLicenseInfo implements Comparable<JLicenseInfo>
{
	...
	public LinkedList<JLicenseInfo> getLicences()
	{
		...
		// Load licence type → filename mappings
		int position = 1;
		...
		typeList.add(new JLicenseInfo("LogoViewer", "GNU General Public License V2.txt", Common.version, "GNU General Public License V2"));
